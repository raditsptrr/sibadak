...
<div class="container-card">
    <h1 class="text-2xl font-bold text-gray-800 mb-8">Tambah Kategori Utama Baru</h1>
    ...
    <form action="{{ route('admin.main-categories.store') }}" method="POST">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-600 mb-2">Nama Kategori Utama</label>
            {{-- [DIUBAH] Menyamakan gaya input dan menambahkan old() untuk error handling --}}
        ...
        <div class="flex items-center gap-6 mt-8">
            ...
            <a href="{{ route('admin.main-categories.index') }}" class="text-gray-600 font-semibold hover:text-gray-900 transition-colors duration-200">
                Batal
            </a>
        </div>
    </form>
